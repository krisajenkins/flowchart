...
Elm.Main.make = function (_elm) {
   ...
   var questionString = function (q) {
      return function () {
         ...
         {case "AreYouSure":
            ...
            case "DoNotDoIt":
            return "Don\'t Do It";
            case "DoYouKnowWhatYouAreDoing":
            return "Do you know what you are doing?";}
         _U.badCase($moduleName,
         "between lines 38 and 42");
      }();
   };
   var DoNotDoIt = {ctor: "DoNotDoIt"};
   var DoIt = {ctor: "DoIt"};
   var AreYouSure = {ctor: "AreYouSure"};
   var DoYouKnowWhatYouAreDoing = {ctor: "DoYouKnowWhatYouAreDoing"};
   var flowchartStart = DoYouKnowWhatYouAreDoing;
   var NoOp = {ctor: "NoOp"};
   var uiChannel = $Signal.channel(NoOp);
   var uiSignal = $Signal.subscribe(uiChannel);
   var Reset = {ctor: "Reset"};
   var NotReally = {ctor: "NotReally"};
   var No = {ctor: "No"};
   var Yes = {ctor: "Yes"};
   var flowchart = _L.fromArray([{ctor: "_Tuple2"
                                 ,_0: DoYouKnowWhatYouAreDoing
                                ...
                                ,{ctor: "_Tuple2"
                                 ...
                                 ,_1: _L.fromArray([{ctor: "_Tuple2"
                                                    ,_0: Reset
                                                    ,_1: flowchartStart}])}]);
   var answers = function (q) {
      return function () {
         var _ = $List.head(A2($List.filter,
         function (_v2) {
            return function () {
               switch (_v2.ctor)
               {case "_Tuple2":
                  return _U.eq(_v2._0,q);}
               _U.badCase($moduleName,
               "on line 56, column 48 to 55");
            }();
         },
         flowchart));
   ...
   var answerQuestion = F2(function (q,
   a) {
      return function () {
         var _ = $List.head(A2($List.filter,
         function (_v9) {
            return function () {
               switch (_v9.ctor)
               {case "_Tuple2":
                  return _U.eq(_v9._0,q);}
               _U.badCase($moduleName,
               "on line 61, column 48 to 55");
            }();
         },
         flowchart));
         var answers = function () {
         ...
         function (_v16) {
            return function () {
               switch (_v16.ctor)
               {case "_Tuple2":
                  return _U.eq(_v16._0,a);}
               _U.badCase($moduleName,
               "on line 62, column 50 to 57");
            }();
         },
         answers));
         var response = function () {
            ...
            {case "_Tuple2": return _._1;}
            _U.badCase($moduleName,
            "on line 62, column 23 to 66");
         }();
         return response;
      }();
   });
   var step = F2(function (a,q) {
      return A2(answerQuestion,
      q,
      a);
   });
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,Reset: Reset
                      ,NoOp: NoOp
                      ,DoYouKnowWhatYouAreDoing: DoYouKnowWhatYouAreDoing
                      ,AreYouSure: AreYouSure
                      ,DoIt: DoIt
                      ,DoNotDoIt: DoNotDoIt
                      ,flowchartStart: flowchartStart
                      ,flowchart: flowchart
